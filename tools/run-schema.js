...
var schema = [
	...
	'insert into users (id, username, firstname, lastname, created) values ('+config.bot.user_id+', \''+bot_number+'\', \'VoteBot\', \'\', now()) on conflict (id) do update set username = \''+bot_number+'\'',
