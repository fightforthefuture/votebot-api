    ...
    */
    ...
    },
    {
        ...
        process: function(user) {
            ...
            // ABORT IF WE'RE NOT BETWEEN THE HOURS OF 9am PST and 10pm EST
            var time = moment().tz('America/New_York');
    
            if (time.hour() < 11 || time.hour() > 21) {
                log.notice('    - Time is not between 8am PST and 10pm EST! Skipping...');
                return {};
            }
    ...
    },
    {
        ...
        process: function(user) {
            ...
            // ABORT IF WE'RE NOT BETWEEN THE HOURS OF 7am PST and 10pm EST
            var time = moment().tz('America/New_York');
    
            if (time.hour() < 8 || time.hour() > 21) {
                log.notice('    - Time is not between 5am PST and 10pm EST! Skipping...');
                return {};
            }
