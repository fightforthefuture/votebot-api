/**
 * this is a listing of US Drivers License validations
 * from https://github.com/adambullmer/USDLRegex/blob/master/regex.json
 * original format https://ntsi.com/drivers-license-format/
 * US passport format https://www.uscis.gov/e-verify/about-program/e-verify-enhancements/us-passport-and-visa-number-entry
 */
...
var USDL = {
  ...
  "AZ": {
    ...
    "description": [
      "1 Alpha + 1-8 Numeric",
      "9 Numeric"
      // AZ OVR form requires 9 alpha-numeric
    ]
  },
  "AR": {
    "rule": "^[0-9]{4,9}$",
  ...
  "US": {
    "rule": "(^[A-Z0-9]{6,9}$)|(^C{1}[0-9]{8}$)",
    "description": [
      "Passport: 6-9 Alpha Numeric",
      "Card: C+8 Numeric"
    ]
  }
};

exports.validate = function(state, id)
{
  return id.toUpperCase().match(USDL[state.toUpperCase()].rule);
}
