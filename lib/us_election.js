...
exports.get_ovr_deadline = function(abbr) {
    ...
    var state_name = exports.abbr_to_name(state);
    var deadlines = registration_deadlines[state_name]["Deadlines"];
...
exports.state_required_questions = {
    ...
    CA: ['us_citizen', 'legal_resident', 'will_be_18', 'state_id', 'ssn_last4', 'consent_use_signature'],
