...
// some states do not allow online voter registration, give these users specific instructions
...
exports.required_questions_default = ['us_citizen', 'will_be_18'];
...
exports.state_required_questions = {
    ...
    AZ: ['has_separate_mailing_address', 'legal_resident', 'political_party', 'state_id_number', 'ssn_last4', 'ovr_disclosure'],
    AR: ['state_id_number', 'state_id_or_ssn_last4',],
    CA: ['political_party', 'state_id_number', 'ssn_last4', 'consent_use_signature', 'ovr_disclosure'],
    CO: ['gender', 'military_or_overseas', 'vote_by_mail', 'political_party', 'phone', 'state_id_number', 'state_id_or_ssn_last4', 'consent_use_signature', 'ovr_disclosure'],
    ...
    GA: ['political_party', 'state_id_number', 'consent_use_signature', 'ovr_disclosure'],
    HI: ['gender', 'state_id_number', 'ssn'],
    ID: ['state_id_number', 'state_id_or_ssn_last4'],
    IL: ['gender', 'county', 'has_previous_address', 'has_previous_name', 'political_party', 'state_id_number', 'state_id_issue_date', 'ssn_last4', 'ovr_disclosure'],
    IN: ['state_id_number', 'state_id_or_ssn_last4'],
    IA: ['state_id_number', 'state_id_or_ssn_last4'],
    KS: ['state_id_number', 'state_id_or_ssn_last4'],
    KY: ['ssn', 'political_party', 'ovr_disclosure'],
    ...
    ND: ['ineligible',],
    OH: ['state_id_number', 'state_id_or_full_ssn'],
    OK: ['ssn_last4',],
    ...
    VA: ['gender', 'legal_resident', 'change_state', 'state_id_number', 'consent_use_signature', 'confirm_name_address', 'ssn', 'political_party', 'ovr_disclosure'],
