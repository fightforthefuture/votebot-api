var registration_requirements = {
  ...
  "New York": {
    "Requirements": [
      ...
      "Not be in jail or prison, or on parole for a felony conviction",
  ...
  "North Dakota": {
    "NOTE": "You don't need to register to vote in North Dakota. Instead, make sure you meet all the voting requirements, and provide ID to vote on Election Day, Nov 8.",
    "Requirements": [
      "Be a US citizen",
      "Be at least 18 years old on Election Day, **Nov 8**",
...
exports.state_required_questions = {
    ...
    VA: ['will_be_18', 'gender', 'legal_resident', 'change_state', 'state_id_number', 'consent_use_signature', 'ovr_disclosure'],

    // JL DEBUG ~ remove this in production!
    // --------------------------------------------------------------------
    // MN: ['us_citizen', 'will_be_18', 'political_party', 'state_id_number', 'ovr_disclosure'],
    // --------------------------------------------------------------------

    //NM: ['us_citizen', 'legal_resident', 'will_be_18', 'disenfranchised', 'state_id_number', 'ssn'],
};
...
exports.state_confirmation_disclosures = {
  ...
  MA: {
    text: 'I hereby swear (affirm) that I am the person named above, that the above information is true, that I AM A CITIZEN OF THE UNITED STATES, that I am at least 16 years old and I understand that I must be 18 years old to be eligible to vote, that I am not a person under guardianship which prohibits my registering to vote, that I am not temporarily or permanently disqualified by law from voting because of corrupt practices in respect to elections, that I am not currently incarcerated for a felony conviction, and that I consider this residence to be my home.',
...
exports.required_questions_default = ['us_citizen', 'will_be_18', 'political_party', 'state_id_number'];
