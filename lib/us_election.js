...
exports.get_ovr_deadline = function(abbr) {
    ...
    var requirements = registration_requirements[state_name]
    if (requirements) {
...
// some states do not allow online voter registration
exports.states_without_ovr = {
    NH: 'NH prefers that voters register in person. You must visit your town clerk to get a registration form. Find them at http://app.sos.nh.gov/Public/ClerkDetails.aspx', 
...
// enable specific questions to match votebot-forms
// JL NOTE ~ we must ask political_party in all of these so the vote.org fallback works
exports.state_required_questions = {
    AK: ['will_be_18', 'us_citizen', 'state_id_number', 'ssn_last4'],
    AZ: ['will_be_18', 'has_separate_mailing_address', 'legal_resident', 'political_party', 'state_id_number', 'ssn_last4', 'ovr_disclosure'],
    CA: ['will_be_18', 'political_party', 'state_id_number', 'ssn_last4', 'consent_use_signature', 'ovr_disclosure'],
    CO: ['will_be_18', 'gender', 'military_or_overseas', 'vote_by_mail', 'political_party', 'phone', 'state_id_number', 'consent_use_signature', 'ovr_disclosure'],
    GA: ['will_be_18', 'political_party', 'state_id_number', 'consent_use_signature', 'ovr_disclosure'],
    HI: ['will_be_18', 'gender', 'state_id_number', 'ssn'],
    IL: ['will_be_18', 'gender', 'county', 'has_previous_address', 'has_previous_name', 'political_party', 'state_id_number', 'state_id_issue_date', 'ssn_last4', 'ovr_disclosure'],
    KY: ['will_be_18', 'ssn', 'political_party', 'ovr_disclosure'],
    MA: ['will_be_18', 'political_party', 'state_id_number', 'consent_use_signature', 'ovr_disclosure'],
    VA: ['will_be_18', 'gender', 'legal_resident', 'change_state', 'state_id_number', 'consent_use_signature', 'confirm_name_address', 'ssn', 'political_party', 'ovr_disclosure'],
    VT: ['will_be_18', 'us_citizen', 'legal_resident', 'state_id_number', 'ovr_disclosure'],
    WV: ['will_be_18', 'us_citizen', 'legal_resident', 'state_id_number', 'ssn_last4', 'consent_use_signature', 'ovr_disclosure']
};
...
exports.state_confirmation_disclosures = {
  ...
  VT: {
    text: 'Do you swear or affirm that these are true statements:\n'+
...
// defaults for national voter registration form
exports.required_questions_default = ['us_citizen', 'will_be_18', 'state_id_number'];
