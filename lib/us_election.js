...
exports.state_required_questions = {
    AZ: ['has_separate_mailing_address', 'us_citizen', 'legal_resident', 'political_party', 'will_be_18', 'incompetent', 'disenfranchised', 'ssn_last4', 'ovr_disclosure'],
    CA: ['legal_resident', 'will_be_18', 'political_party', 'state_id_number', 'ssn_last4', 'consent_use_signature', 'ovr_disclosure'],
    ...
    GA: ['us_citizen', 'legal_resident', 'will_be_18', 'political_party', 'state_id_number', 'consent_use_signature', 'ovr_disclosure'],
    IL: ['gender', 'county', 'has_previous_address', 'political_party', 'has_previous_name', 'will_be_18', 'state_id_number', 'state_id_issue_date', 'ssn_last4', 'ovr_disclosure'],
    MA: ['political_party', 'state_id_number', 'consent_use_signature', 'ovr_disclosure'],
