...
var turbovote = require('../lib/turbovote');
...
exports.is_election_day = function() {
...
exports.get_early_voting_or_mail_in = function(abbr) {
  var state_name = us_states.abbr_to_name(abbr);            

  // Massage data for turbovote
  if (state_name == 'District of Columbia') state_name = 'D.C.';

  var turbo_data = turbovote.early_voting_periods[state_name];

  if (!turbo_data) return 'none';

  if (turbo_data['Type'] == 'vote-by-mail')
    return turbo_data['Type'];
  
  var today = moment(),
      start_date = moment(turbo_data['StartDate'], 'YYYY-MM-DD');

  if (today.isAfter(start_date))
    return turbo_data['Type'];

  return false;
}

exports.get_early_voting = function(abbr) {
  var state_name = us_states.abbr_to_name(abbr);
  var early_voting = turbovote.early_voting_periods[state_name]
  if (early_voting) {
    return early_voting;
  } else {
    return {};
...
exports.get_mail_deadline_text = function(abbr) {
  ...
  if (!deadline_text || config.election.ignore_deadlines) {
...
exports.state_required_questions = {
    ...
    CA: ['political_party', 'county', 'state_id_number', 'ssn_last4', 'vote_by_mail', 'consent_use_signature', 'ovr_disclosure'],
    ...
    MO: ['state_id_number', 'ssn_last4', 'gender'],
...
// these cute gif urls are from 2016
// disable until we generate new ones for 2018
...
/*
    ...
    KS: {
        tweet_url: 'https://fftf.io/ks',
        image: 'https://hello.vote/images/animations/ks.gif'
    },
    KY: {
    ...
    MA: {
        tweet_url: 'https://fftf.io/ma',
        image: 'https://hello.vote/images/animations/ma.gif'
    },
    MI: {
    ...
    MN: {
        tweet_url: 'https://fftf.io/mn',
        image: 'https://hello.vote/images/animations/mn.gif'
    },
    NC: {
    ...
    NJ: {
        tweet_url: 'https://fftf.io/nj',
        image: 'https://hello.vote/images/animations/nj.gif'
    },
    NY: {
    ...
    NV: {
        tweet_url: 'https://fftf.io/nv',
        image: 'https://hello.vote/images/animations/nv.gif'
    },
    OH: {
    ...
    OR: {
        tweet_url: 'https://fftf.io/or',
        image: 'https://hello.vote/images/animations/or.gif'
    },
    OK: {
    ...
    WV: {
        tweet_url: 'https://fftf.io/wv',
        image: 'https://hello.vote/images/animations/wv.gif'
    },  
*/
}
