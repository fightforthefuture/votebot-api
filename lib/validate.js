...
{
    if (!isNaN(body.trim()) && parseInt(body.trim()) < 7)
        body = (parseInt(body.trim()) + 12)+"";
    ...
    if (time.isValid()) {
        ...
        return Promise.resolve([time.format('HH:mm')]);
    } else {
...
exports.accept_anything = function(body, user, locale)
{
