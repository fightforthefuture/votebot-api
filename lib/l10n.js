var l10n = {
    ...
    error_military_or_overseas: {
        ...
        es: "Lo siento, no entendí eso. Por favor contesta (militar/extranjero/no)"ES: "Lo siento, no entendí eso. Por favor conteste (militar/extranjero/no)"
,
    ...
    msg_error_failed: {
        ...
        ko: "유권자 등록 처리에 문제가 생겼습니다. 죄송합니다. 레퍼런스 번호 #{{reference}} 를 이메일 team@hellovote.org 으로 보내서 알려주세요"
    },
    msg_processing: {
    ...
    prompt_has_previous_name: {
        ...
        ko: "예전에 {{setting.state}} 주 에서 다른 이름으로 유권자 등록을 한 적이 있나요?"
    },
    ...
    prompt_commit_to_vote_from_notification: {
        ...
        es: 'Hola, {{primer_nombre}} soy “HelloVote” Día de Elección se acerca! Te gustaria recibir una invitación de calendario con la ubicación del lugar a donde votar?',
    ...
    prompt_commit_to_vote: {
        ...
        es: '{{primer_nombre}], vamos a prepararte para votar el dia martes, dia de votar. Te gustaría recibir una invitación de calendario con la ubicación del lugar a donde votar?',
    ...
    msg_polling_place: {
        ...
        es: 'Su lugar de votar esta {{ubicación}} {{ubicación_cuidad}} {{results.polling_place.link}}',
    ...
    msg_gotv_1_reintro: {
        ...
        es: 'Hola {{primer_nombre}}, soy“HelloVote”',
    ...
    msg_gotv_1_reintro_from_notification: {
        ...
        es: 'Hola {{primer_nombre}} soy“HelloVote. Manana es dia de eleccion! Esta usted listo para votar ',
    ...
    msg_thanks_for_using: {
        ...
        ko: "elloVote를 사용 해 주셔서 감사합니다"
    },
    msg_disabled: {
        en: 'Thanks for using HelloVote! This bot is now disabled!',
        ko: "elloVote를 사용 해 주셔서 감사합니다. 서비스가 종료되었습니다."
    }
};
