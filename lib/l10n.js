var l10n = {
    ...
    msg_share_sms: {
        en: "Forward this message to everyone you care about! Register to vote by text message: Visit https://hello.vote or txt HELLO to sms:384-387",
        es: "¡Reenvíe el mensaje siguiente a sus amigos! Registrese para votar por mensaje de texto: Visite https://hello.vote o envia HOLA por SMS a 384-387"
    },
    msg_sms_notice: {
    ...
    msg_share_sms_gotv: {
        en: "Forward this message to everyone you care about! Register to vote and get to the polls: Visit https://hello.vote or txt HELLO to sms:384-387",
        es: "¡Reenvíe el mensaje siguiente a sus amigos! Registrese para votar por mensaje de texto: Visite https://hello.vote o envia HOLA por SMS a 384-387"
    },
    msg_i_voted_selfie: {
    ...
    prompt_commit_to_vote_from_notification: {
        en: "Hey {{first_name}}, it's HelloVote! Are you ready to vote on Tuesday, Election Day? We can send you a calendar invite with directions to the polls."
    },
    prompt_commit_to_vote: {
        en: "{{first_name}}, are you ready to vote on Tuesday, Election Day? We can send you a calendar invite, so you can make time to get to the polls."
    },
    prompt_zip_gotv: {
