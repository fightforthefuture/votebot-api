var l10n = {
    msg_intro: {
        ...
        es: "(Saludos, esto es HolaVote. Puedo revisar si está registrado o ayudarle a registrarse para votar. Sus respuestas son privadas y seguras. Más información: hellovote.org)"
    },
    ...
    msg_intro_facebook: {
        ...
        es: "Bueno, yo puedo ayudarle a registrarse para votar. Le haré unas preguntas para completar el formulario de inscripción. Sus respuestas son privadas y seguras."
    },
    prompt_first_name: {
    ...
    error_zip: {
        ...
        es: "Por favor, ingrese su código postal de cinco dígitos, o ingrese SALTAR si no lo sabes."
    },
    prompt_city: {
    ...
    error_email: {
        ...
        es: "Por favor, ingrese su correo electrónico. Si no tiene uno, responde SALTAR"
    },
    ...
    msg_already_registered: {
        ...
        es: "¡Felicidades! Nuestros datos dicen que ya esta registrado para votar en esa dirección."
    },
    ...
    prompt_political_party: {
        ...
        es: "¿Cuál es su preferencia de partido? (demócrata/republicano/libertario/verde/otro/ninguno)"
    },
    ...
    error_state_deadline_expired: {
        ...
        es: "Lo siento, la fecha límite de inscripción para votar en {{settings.state}} ha pasado. Puede ser elegible a inscribirse para votar en persona."
    },
    error_validate_state_abbreviation: {
    ...
    msg_unsubscribed: {
        ...
        es: "Usted anuló su suscripción de Fight for the Future. No va a recibir más mensajes. Email team@hello.vote to reiniciar."
    },
    msg_help: {
