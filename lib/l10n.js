var l10n = {
    msg_intro: {
        en: "(Hi, this is HelloVote! I can check to see if you're registered & then help you register to vote! Your answers are private & secure. Learn more: hellovote.org)",
        es: "(Saludos, esto es HelloVote. Puedo revisar si está registrado o ayudarle a registrarse para votar. Sus respuestas seran privadas y seguras. Más información: hellovote.org)"
    },
    ...
    msg_election_day_hotline: {
        en: 'Today is Election Day, and we\'ll make sure you get to the polls! If you or anyone you know is having trouble voting, call this legal hotline: 1-866-OUR-VOTE',
    },
    msg_polling_place: {
    ...
    msg_did_you_vote: {
        en: 'Did you vote? (yes/no)',
    },
    msg_vote_reschedule: {
        en: 'That\'s okay, you have until {{results.polling_place.close_time}}. What time can you go?',
    },
    msg_i_voted: {
        en: 'Awesome! \u{1F3C5} Click here to take a selfie with an "I Voted" badge, to motivate your friends to the polls! https://fftf.io/ivoted'
    },
    msg_share_gotv: {
        en: 'Help motivate your friends to the polls and share your badge!',
    },
