var l10n = {
    msg_intro: {
        en: "Hi, this is HelloVote! I can send you everything you need to go vote, and help you invite friends too! Your answers are private & secure. hello.vote",
        es: "Saludos, esto es HelloVote. Yo puedo ayudarle a registrarse para votar, recuerda a votar, y recuerde a sus amigos a ver demasiado. Sus respuestas seran privadas y seguras. hello.vote"
    },
    ...
    msg_complete_ovr_disclaimer: {
        en: 'Don\'t assume you\'re registered until you confirm with your state: hello.vote/{{settings.state}} - it may take days or weeks, but plz check! Your vote is important!',
        es: "No suponga que esta registrado hasta que lo confirme con su estado: hello.vote/{{settings.state}} - se puede tardar días o semanas, pero reviselo por favor. ¡Su voto es importante!",
        ko: "다음의 웹사이트에서 등록 여부를 확인 할 수 있습니다: hello.vote/{{settings.state}}\n주에 따라 며칠 또는 몇주 걸릴 수 있습니다. 하지만 꼭 확인하시고, 신청을 했다고 등록이 되었다고 단정하지 마세요!"
    },
    msg_complete_pdf: {
    ...
    msg_help: {
        en: 'To go back a step, say BACK. To unsubscribe, say STOP. To start over, re-enter your # on hello.vote. All other questions, email team@hello.vote',
        ...
        ko: "전 단계로 돌아가기 위해서는 back 을 입력하세요. 구독을 해지하기 위해서는 stop 을 입력하세요. 처음부터 시작하기 위해서는 hello.vote 를 방문해서 전화번호를 입력하세요. 질문은 team@hello.vote 으로 보내주세요."
    },
    msg_help_default: {
