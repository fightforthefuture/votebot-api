var l10n = {
    ...
    msg_election_day_directions: {
        en: 'In case you need it, here\'s a map to your polling place, {{results.polling_place.address.locationName}} in {{results.polling_place.address.city}}:\n{{results.polling_place.link}}',
    }
};
