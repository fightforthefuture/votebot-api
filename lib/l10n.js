var l10n = {
    msg_intro: {
        en: "Hi this is HelloVote! I'm going to help make sure you are registered to vote. I'll ask a few questions to fill out your registration form. Your answers are private and secure.",
        es: "Hola"
    },
    ...
    msg_already_registered: {
        en: 'It looks like you\'re already registered to vote in {{settings.state}}! We will send you important voting updates before election day.'
    },
    msg_complete: {
    ...
    prompt_ssn_last4: {
        en: "Your state also wants to know the last 4 of your SSN."
    },
    error_ssn_last4: {
        en: "Please enter the last 4 digits of your SSN."
    },
    prompt_state_id_or_ssn_last4: {
        en: "Alright, last thing - in order to finish your registration, your state wants to know your social security or {{settings.state}} id number."
    },
    ...
    msg_complete_pdf: {
        en: "Check your email! I just sent your completed voter registration form. We already paid the postage, so you just have to print, sign, and mail!"
    },
    msg_complete_pdf_fb: {
        en: "Here's your voter registration form! Please print it out and follow the instructions to sign and mail it to your state. (I also emailed you a copy)"
    },
    msg_complete_mail: {
        en: "I'm mailing your voter registration form! It should arrive by {{mail_eta}}. Once you get it, please follow the instructions to sign & mail it to your state!"
    },
    msg_ovr_failed: {
