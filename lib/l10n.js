var l10n = {
    ...
    prompt_apartment: {
        en: "Apartment number? (If you don't have one, reply: none)"
    },
    error_apartment: {
    ...
    prompt_confirm_name_address: {
        en: 'The name and address we have for you is:\n{{first_name}} {{last_name}}, {{settings.address}} {{settings.city}} {{settings.state}}\nIs this correct (yes/no)?'
    },
    error_confirm_name_address: {
        en: 'Please reply "yes" or "no" to confirm your information'
    },
    msg_complete: {
        en: "Congratulations! We have submitted your voter registration in {{settings.state}}! We just emailed you a receipt."
    },
    prompt_incomplete: {
        en: "Sorry, your registration is incomplete. Restart?"
    },
    msg_share: {
        en: "Now, there's one last important thing. We need you to pass on the <3 and register some friends! Can you share this on Facebook? https://fftf.io/hellovote"
    },
    prompt_restart: {
        en: "This will restart your HelloVote registration! Reply (ok) to continue."
    },
    prompt_us_citizen: {
    ...
    prompt_state_id_number: {
        en: "Alright, last thing - in order to finish your registration, {{settings.state}} wants to know your drivers license or state-issued ID number. (I don't store this info!)"
    },
    ...
    prompt_ssn: {
        en: "One more thing - in order to finish your registration, your state wants to know your social security number. (I don't store this info!)"
    },
    prompt_ssn_last4: {
        en: "Your state also wants to know the last 4 of your SSN. (I don't store this info either!)"
    },
    error_ssn_last4: {
        en: "Please enter the last 4 digits of your SSN."
    },
    prompt_state_id_or_ssn_last4: {
        en: "Alright, last thing - in order to finish your registration, your state wants to know your social security or {{settings.state}} id number. (I don't store this info either!)"
    },
    ...
    prompt_consent_use_signature: {
        en: "To submit your registration directly with the state, I can use your signature on file with the DMV. Reply (yes) to submit."
    },
    error_consent_use_signature: {
        en: "Please reply YES to let us submit your registration using your signature from the DMV. I do not store this information."
    },
    prompt_vote_by_mail: {
        en: "Would you like to vote by mail-in ballot?"
    },
    prompt_fftf_opt_in: {
        en: "Oh, I almost forgot. HelloVote is made by FightForTheFuture.org which protects the world-changing power of the Internet. Join us for campaign updates? (yes/no)"
    },
    ...
    error_validate_date: {
        en: 'That\'s not a valid date. Please format like MM/DD/YYYY'
    },
    error_validate_phone: {
        en: 'Sorry, that wasn\'t a valid phone number. Please format like 510-555-1212'
    },
    error_validate_email: {
        en: 'We need your email address to send you a registration receipt and voting reminders. If you don\'t have one, reply NONE.'
    },
    ...
    error_validate_zip_is_bogus: {
        en: 'We couldn\'t find that zip code'
    },
    error_validate_address: {
        en: 'Please enter your mailing address.'
    },
    error_validate_address_is_bogus: {
        en: 'We couldn\'t find that street address. Please try again.'
    },
    error_validate_apartment: {
        en: 'We couldn\'t verify that apartment number. Please try again.'
    },
    ...
    error_validate_state_id_number: {
        en: 'Please enter a valid {{settings.state}} ID. If you don\'t have one, we can\'t submit your registration. Reply NONE and we\'ll send you a form to print and mail.'
    },
    ...
    prompt_email_for_ovr: {
        en: "Almost done! Now, {{settings.state}} requires an email for online registration. We'll also send you crucial voting information. What's your email?"
    },
    ...
    msg_complete_pdf: {
        en: "Great! In a moment, we’ll email you a completed voter registration form to print, sign, and mail."
    },
    error_incomplete: {
