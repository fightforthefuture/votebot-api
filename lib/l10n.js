var l10n = {
    ...
    msg_already_registered: {
        en: 'It looks like you\'re already registered to vote in {{settings.city}}, {{settings.state}}! We will send you important voting updates before election day.'
    },
    msg_not_yet_registered: {
        en: 'Our data doesn’t show you registered at that address, so let’s continue and register you.',
    },
    msg_complete: {
