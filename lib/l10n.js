var l10n = {
    msg_intro: {
        en: "Hi, this is HelloVote! I can send you everything you need to go vote, and help you invite friends too! Your answers are private & secure. https://hello.vote",
        es: "Saludos, esto es HelloVote. Yo puedo ayudarle a registrarse para votar, recuerda a votar, y recuerde a sus amigos a ver demasiado. Sus respuestas seran privadas y seguras. https://hello.vote"
    },
    ...
    msg_share_sms: {
        ...
        ko: "간편한 스마트폰 유권자 등록에 대해 널리 알려주세요! https://hello.vote 를 방문하시면 시작 할 수 있습니다."
    },
    msg_sms_notice: {
    ...
    msg_complete_ovr_disclaimer: {
        en: 'Don\'t assume you\'re registered until you confirm with your state: https://hello.vote/{{settings.state}} - it may take days or weeks, but plz check! Your vote is important!',
        es: "No suponga que esta registrado hasta que lo confirme con su estado: https://hello.vote/{{settings.state}} - se puede tardar días o semanas, pero reviselo por favor. ¡Su voto es importante!",
        ko: "다음의 웹사이트에서 등록 여부를 확인 할 수 있습니다: https://hello.vote/{{settings.state}}\n주에 따라 며칠 또는 몇주 걸릴 수 있습니다. 하지만 꼭 확인하시고, 신청을 했다고 등록이 되었다고 단정하지 마세요!"
    },
    msg_complete_pdf: {
    ...
    msg_help: {
        en: 'To go back a step, say BACK. To unsubscribe, say STOP. To start over, re-enter your # on https://hello.vote. All other questions, email team@hello.vote',
        es: "Para regresar, diga REGRESAR. Para anular su suscripción, diga STOP. Para volver a empezar, re-ingrese su # en https://hello.vote/es. Para otras preguntas envíe un mensaje a team@hello.vote",
        ko: "전 단계로 돌아가기 위해서는 back 을 입력하세요. 구독을 해지하기 위해서는 stop 을 입력하세요. 처음부터 시작하기 위해서는 https://hello.vote 를 방문해서 전화번호를 입력하세요. 질문은 team@hello.vote 으로 보내주세요."
    },
    msg_help_default: {
    ...
    msg_error_failed: {
        en: 'Agh, an error occurred and your voter registration could not be processed. Please let us know: team@hello.vote - reference #',
        es: "¡Ay! Un error occurio y su inscripción para votar no pudo ser procesada. Por favor avísenos: team@hello.vote - # de referencia  ",
        ko: "유권자 등록 처리에 문제가 생겼습니다. 죄송합니다. 이메일 team@hello.vote 로 다음의 레퍼런스 번호를 보내주세요: #"
    },
    msg_processing: {
    ...
    msg_polling_place: {
        ...
        es: 'Su lugar de votar esta {{location}} {{location_city}} {{results.polling_place.link}}',
