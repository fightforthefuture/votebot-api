var l10n = {
    ...
    prompt_zip: {
        en: "Now, what's your zip code? (By the way, you can say \"go back\" if you ever need to go back a step, or \"help\" for more options!)",
        es: "Ahora, ¿cuál es su código postal? (A propósito, puedes decir \"regresar\" si quieres retroceder un paso o \"ayuda\" para más opciones)"
    },
    prompt_zip_gotv: {
    ...
    msg_end_conversation: {
        en: "Sorry - based on your answer, we can\'t continue. Please say BACK if you need to make a correction. Or, say YES and share with your friends!",
        es: "Lo sentimos -- en base a sus respuestas, no podemos continuar. Por favor diga REGRESAR si necesita corregir algo, o SI y comparta con sus amigos!"
    },
    error_validate_date: {
    ...
    error_validate_number: {
        en: 'I didn\'t understand that number. Please just enter digits.',
    },
    ...
    msg_gotv_intro: {
        en: "(Hi, this is HelloVote! I can help you get to the polls on Election Day! Your answers are private & secure. Learn more: hellovote.org)",
    },
    msg_election_day_tomorrow: {
        en: 'Election Day is tomorrow!',
    },
    msg_election_day_hotline: {
        en: 'It\'s Election Day and HelloVote can make sure you get to the polls! If you or anyone you know is having trouble voting, call this legal hotline 1-866-OUR-VOTE',
    ...
    msg_polling_place: {
        en: 'Your polling place is the {{results.polling_place.address.locationName}} in {{results.polling_place.address.city}}. {{results.polling_place.link}}',
    },
    ...
    msg_vote_reschedule: {
        en: 'That\'s okay, you have until {{results.polling_place.close_time}}. What time can you go?',
    },
    ...
    prompt_early_voting: {
        en: 'Hey {{first_name}}, it\'s HelloVote. Early voting has started in your state! When are you going to vote?'
    },
    ...
    prompt_commit_to_vote: {
        en: "Hey {{first_name}} it\'s HelloVote. Are you ready to vote on Tuesday, Election Day? We can send you a calendar invite, so you can make time to get to the polls."
    },
    prompt_zip_gotv: {
        en:  "Now, what's your zip code? To get your Election Day info, we need to know where you're registered to vote.",
    },
