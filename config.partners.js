module.exports = {
    ...
    changetheref: {
        intro_shortcode: 'changetheref',
        msg_intro: "(Hi, this is Change the Ref and HelloVote! I can check to see if you\'re registered, and then help you register to vote!)",
    },
    care2: {
    ...
    krcla: {
        ...
        msg_intro_ko: "안녕하세요, 아까 민족학교의 실무진과 대화하면서 유권자 등록에 관심을 보여주셔서 감사합니다! 저는 민족학교와 HelloVote 를 통해 문자 메세지로 유권자 등록을 할 수 있도록 도와드리는 자동 시스템입니다, 저의 질문에 하나씩 답변을 입력하시면 그것만으로 손쉽게 유권자 등록을 할 수 있습니다",
    },
    lvp: {
        intro_shortcode: 'lvp',
        msg_intro: "(Hi, this is LVP and HelloVote! I can check to see if you\'re registered, and then help you register to vote!)",
    ...
    walkerandco: {
        ...
        msg_intro: "(Hi, this is Walker and Company and HelloVote! I can check to see if you\'re registered, and then help you register to vote!)",
    },
    wiuvotes: {
